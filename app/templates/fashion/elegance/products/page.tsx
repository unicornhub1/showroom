...
function ProductsPageContent() {
  ...
  function handleCategoryChange(cat: string) {
    ...
    router.push(`/templates/fashion/elegance/products?${params.toString()}`, {
      scroll: false,
    })
  }
          ...
          {activeCollection && (
            <div className="flex items-center gap-4 mt-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs tracking-wider uppercase px-3 py-1.5 rounded-sm transition-colors duration-300 hover:bg-[var(--el-light)]"
                style={{
                  fontFamily: 'var(--el-font-sans)',
                  color: 'var(--el-gray)',
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  style={{
                    fontFamily: 'var(--el-font-sans)',
                    backgroundColor: isActive ? 'var(--el-gold)' : 'transparent',
                    color: isActive ? 'var(--el-offwhite)' : 'var(--el-gray)',
                    border: isActive
              ...
              >
                {SORT_OPTIONS.map((option) => (
                  <button
                    ...
                    className="block w-full text-left px-5 py-2.5 text-xs tracking-wider transition-colors duration-200 hover:bg-[var(--el-cream)]"
                    style={{
                      fontFamily: 'var(--el-font-sans)',
                      color:
                        sortBy === option.value
