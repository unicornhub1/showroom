...
function Toast({
  ...
  return (
    <div
      className="animate-jd-toast-in pointer-events-auto flex items-stretch overflow-hidden rounded-lg shadow-lg"
      style={{
  ...
  return (
    <CartContext.Provider value={value}>
      ...
      <style>{`
        ...
        .animate-jd-toast-in {
          animation: jd-toast-slide-in 0.35s ease-out both;
        }
      `}</style>
