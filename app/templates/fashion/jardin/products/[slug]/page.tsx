  ...
  if (!product) {
    return (
      ...
      >
        ...
        <Link
          href={`${BASE}/products`}
          className="text-xs tracking-[0.15em] uppercase underline underline-offset-4 transition-colors duration-300 hover:text-[var(--jd-sage)]"
          style={{
            fontFamily: 'var(--jd-font-sans)',
            color: 'var(--jd-charcoal)',
          }}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <nav className="mb-8 pt-4">
            ...
            >
              ...
              <li className="opacity-40">/</li>
              <li style={{ color: 'var(--jd-charcoal)' }}>{product.name}</li>
            </ol>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
            ...
            <div className="lg:col-span-7">
              <FadeIn>
                {/* Main image */}
                <div
                  className="aspect-[3/4] w-full relative rounded-2xl overflow-hidden"
                  ...
                  >
                    {product.image && (
                      <Image
                        ...
                        sizes="(max-width: 1024px) 50vw, 29vw"
                        className="object-cover"
                        style={{ filter: 'brightness(0.95) hue-rotate(5deg)' }}
                      />
                    )}
                  </div>
                </div>
                ...
                <FadeIn delay={150}>
                    ...
                    <div className="mb-6">
                      ...
                      >
                        ...
                        <span
                          ...
                          style={{ color: 'var(--jd-sand)', fontWeight: 300 }}
                        >
                          {selectedColor}
                        </span>
                      </p>
                            ...
                            <button
                              ...
                              style={{
                                ...
                                boxShadow: isSelected
                                  ? `0 0 0 2px var(--jd-offwhite), 0 0 0 3px var(--jd-sage)`
                            ...
                            >
                              {isSelected && (
                                <Check
                                  ...
                                  style={{
                                    color:
                                      isLightColor(color.hex) ? 'var(--jd-charcoal)' : 'var(--jd-offwhite)',
                                  }}
                                />
                              )}
                            </button>
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 text-[11px] tracking-wider transition-colors duration-300 hover:text-[var(--jd-sage)]"
                        style={{
                          fontFamily: 'var(--jd-font-sans)',
                          color: 'var(--jd-sand)',
                        }}
                      ...
                      {product.sizes.map((size) => {
                        ...
                        return (
                          <button
                            ...
                            className="rounded-lg py-3 text-[11px] tracking-wider uppercase transition-all duration-300 text-center"
                            style={{
                              fontFamily: 'var(--jd-font-sans)',
                  ...
                  <div className="mb-6">
                    ...
                    >
                      <button
                        ...
                        className="flex h-10 w-10 items-center justify-center transition-colors hover:bg-[var(--jd-cream)] rounded-l-lg"
                      >
                        <Minus size={14} style={{ color: 'var(--jd-charcoal)' }} />
                      </button>
                      <span
                        className="flex h-10 w-12 items-center justify-center text-sm border-x"
                        style={{
                          fontFamily: 'var(--jd-font-sans)',
                          color: 'var(--jd-charcoal)',
                      ...
                      <button
                        ...
                        className="flex h-10 w-10 items-center justify-center transition-colors hover:bg-[var(--jd-cream)] rounded-r-lg"
                      >
                        <Plus size={14} style={{ color: 'var(--jd-charcoal)' }} />
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 mb-2">
                    <button
                      ...
                      className="flex-1 rounded-lg py-4 text-[11px] tracking-[0.2em] uppercase transition-all duration-500 disabled:opacity-40 disabled:cursor-not-allowed"
                      style={{
                        fontFamily: 'var(--jd-font-sans)',
                    ...
                    <button
                      ...
                      className="flex h-[52px] w-[52px] items-center justify-center rounded-lg transition-all duration-300"
                      style={{
                  ...
                  <div>
                    <Accordion title="Versand" defaultOpen>
                      ...
                      >
                        Kostenloser Versand für alle Bestellungen über 150 EUR. Die
                        Standardlieferung dauert 3-5 Werktage. Alle Bestellungen werden
                        in recycelbarem Seidenpapier liebevoll verpackt.
                      </p>
                    </Accordion>

                    <Accordion title="Retouren">
                      <p
                        className="text-[13px] leading-[1.9]"
                        style={{
                          fontFamily: 'var(--jd-font-sans)',
                    ...
                    <Accordion title="Pflegehinweise">
                      ...
                      >
                        Leinen und Baumwolle bei 30 Grad waschen. Kaschmir und Seide
                        bitte von Hand in kaltem Wasser waschen und flach trocknen lassen.
                        Lederwaren regelmäßig mit natürlichem Lederpflegemittel behandeln.
                      </p>
                    </Accordion>
                  </div>
                </FadeIn>
          ...
          {relatedProducts.length > 0 && (
            <section className="mt-24 md:mt-32">
              ...
              <FadeIn delay={100}>
                <p
                  className="text-[10px] tracking-[0.25em] uppercase text-center mb-3"
                  style={{
                    fontFamily: 'var(--jd-font-sans)',
                    color: 'var(--jd-sage)',
                  }}
